...
<meta http-equiv="content-type" content="text/html; charset=utf-8"/>
    <script type="text/javascript" src="../../ims/js/jquery/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="../../ims/js/jquery/jquery-ui-1.8.17.custom.min.js"></script>
    <script type="text/javascript" src="../../ims/js/jquery/jquery.dataTables.js"></script>
    <script type="text/javascript" src="../../ims/js/jquery/ColReorder.js"></script>
    <script type="text/javascript" src="../../ims/js/jquery/ColReorderWithResize.js"></script>
    <script type="text/javascript" src="../../ims/js/jquery/TableTools.js"></script>
    <link media="all" rel="stylesheet" href="../../ims/css/jquery-ui-1.8.9.custom/jquery-ui-1.8.9.custom.css"
          type="text/css"/>
    <link media="all" rel="stylesheet" href="../../ims/css/ColReorder.css" type="text/css"/>

    <link media="all" rel="stylesheet" href="../../ims/css/demo_table_jui.css" type="text/css"/>
...
<div id="container">
    ...
    <table id="example" cellpadding="0" cellspacing="0" border="1" class="display dataTable">
        ...
        <tr>
            <th align="center"
                style="background: #e6e6e6 url("../../ims/images/ui-bg_glass_75_e6e6e6_1x400.png") 50% 50% repeat-x;color: #555555;">
                Sl No
            </th>
            <th align="center"
                style="background: #e6e6e6 url('../../ims/images/ui-bg_glass_75_e6e6e6_1x400.png') 50% 50% repeat-x;color: #555555;">
        ...
        <tr>
            <th style=" background: #e6e6e6 url('../../ims/images/ui-bg_glass_75_e6e6e6_1x400.png') 50% 50% repeat-x;color: #555555;font-size:11px!important;">
