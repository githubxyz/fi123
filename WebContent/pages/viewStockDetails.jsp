...
<body>
	<div id="container">
		...
		<div id="content">
			...
			<div id="content_main">
			<div class="heading">
					<font size="4px" color="#67a0f5"><b><%=Messages.getString("company_stock_view") %></b></font>
					<br>
				</div>
				<br>
				<table id="example" cellpadding="0" cellspacing="0" border="1"
					...
					<tfoot>
						...
						<tr>
							...
							<th
								style="background: #e6e6e6 url('images/ui-bg_glass_75_e6e6e6_1x400.png') 50% 50% repeat-x; color: #555555; font-size: 11px !important;">
								<input type="text" id="col8" name="col8" value="Type to search"
								class="search_init" />
							</th>
							<th
								style="background: #e6e6e6 url('images/ui-bg_glass_75_e6e6e6_1x400.png') 50% 50% repeat-x; color: #555555; font-size: 11px !important;">
		...
		<script type="text/javascript">
			...
			$("#example tfoot input").keyup(
					function() {
						...
						oTable.fnFilter(this.value, $("#example tfoot input")
								.index(this));
					});
