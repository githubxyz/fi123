...
<div id="container">
        ...
        <div id="content_main">
        	<form action="SaveStockAlart" method="post">
        		Product Master ID :<select name="productMaster.id">
					<option value="1">1</option>
					<option value="2">2</option>
				</select> <br></br>				 
				Max Value :<input type="text"  name="maxVal"  value=""><br></br>
				Min Value :<input type="text"  name="minVal"  value=""><br></br>
        ...
        <tr style="border:1px solid #ccc!important;">
            <td align="center"><%=sad.getProductMaster() %></td>
